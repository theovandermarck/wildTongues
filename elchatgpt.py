...
def compare_top_words(file_paths, top_n=100):
...
if __name__ == "__main__":
    ...
    file_paths = ["pathshere"]

    unique_words = compare_top_words(file_paths, top_n=100)
